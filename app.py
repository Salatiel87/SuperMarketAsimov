...
# O .gitignore lista o que será ignorado ao enviar o diretório pelo Heroku.
# Procfile diz qual instrução será rodada ao subir o projeto no hiroku
# Requirementes: É indicado clonar o ambiente atual. no terminal::  pip freeze > requirements.txt